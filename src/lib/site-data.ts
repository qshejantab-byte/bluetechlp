...
export const capabilities = [
  {
    title: "Touch and write",
    copy: "Annotate, sketch and edit directly on the screen while the room watches it happen.",
  },
  {
    title: "Digital whiteboarding",
    copy: "Boards that can be saved, shared and reopened in the next session.",
  },
  {
    title: "Wireless screen sharing",
    copy: "Present from a laptop or phone without passing a cable around the table.",
  },
  {
    title: "Video conferencing",
    copy: "Bring remote participants into the same discussion as the people in the room.",
  },
  {
    title: "Built-in smart platform",
    copy: "Apps, browser and media run on the display itself, or from a connected PC.",
  },
  {
    title: "Everyday durability",
    copy: "Specified for rooms that are booked back to back, every working day.",
  },
];
...
export const applications = [
  {
    n: "01",
    title: "Education",
    copy: "Classrooms, lecture halls and training rooms where lessons are built with the class, not just shown to it.",
  },
  {
    n: "02",
    title: "Corporate",
    copy: "Meetings, planning sessions and reviews — with remote colleagues in the same conversation.",
  },
  {
    n: "03",
    title: "Government and institutions",
    copy: "Briefings, internal training and institutional communication.",
  },
  {
    n: "04",
    title: "Training and professional development",
    copy: "Workshops and courses where participants work on the material directly.",
  },
  {
    n: "05",
    title: "Hospitality and conference venues",
    copy: "Meeting facilities guests can operate themselves, without calling a technician.",
  },
  {
    n: "06",
    title: "Healthcare and organisations",
    copy: "Case reviews, staff briefings and community programmes.",
  },
];
